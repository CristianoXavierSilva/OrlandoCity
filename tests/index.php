...
<html lang="pt-BR">
    ...
    <head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" type="image/png" href="uploads/images/icone.fw.png">
    </head>
    ...
    <body>
        ...
        <header>
            ...
            <div class="container">
                <img id="logo" src="uploads/images/orlando-logo.png" alt="Logotipo">
            </div>
        ...
        <section>
            ...
            <div id="news" class="container"> 
                ...
                <div class="row thumbnails">
                    <div class="col-md-3">
                        <img src="uploads/noticias/noticia-thumb.jpg" alt="Imagem da notícia">
            ...
            <div id="call-to-action">
                <div class="container">
                    ...
                    <div class="row">
                        <p>
                            dipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam 
                            aliquam quaerat volup tatem. Uteni ad minima veniam, quis nostrum sed quia non numquam eius 
                            modi tempora incidunt ut. quia non numquam eius numquam eius modi temp modi tempora incidunt 
                    ...
                    <div class="row row-max-400">
                        <div class="col-xs-6">
                            <a class="btn btn-roxo" href="#" id="shop"> Shop </a>
                        </div>

                        <div class="col-xs-6">
                            <a class="btn btn-amarelo" href="#" id="register"> Register </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 text-center">
                            <img id="logo-rodape" src="uploads/images/orlando-logo.png" alt="Logotipo">
                        </div>
